...
This guide provides comprehensive documentation for the **ml-monitoring** skill in the custom-plugin-mlops plugin.
...
```bash
# Invoke the skill
claude "ml-monitoring - [your task description]"

# Example
claude "ml-monitoring - analyze the current implementation"
```
...
def implement_ml_monitoring(input_data):
    """
    Implement ml-monitoring functionality.

...
This guide provides comprehensive documentation for the **model-serving** skill in the custom-plugin-mlops plugin.
...
```bash
# Invoke the skill
claude "model-serving - [your task description]"

# Example
claude "model-serving - analyze the current implementation"
```
...
def implement_model_serving(input_data):
    """

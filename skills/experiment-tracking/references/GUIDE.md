...
This guide provides comprehensive documentation for the **experiment-tracking** skill in the custom-plugin-mlops plugin.
...
```bash
# Invoke the skill
claude "experiment-tracking - [your task description]"

# Example
claude "experiment-tracking - analyze the current implementation"
```
...
def implement_experiment_tracking(input_data):
    """
    Implement experiment-tracking functionality.

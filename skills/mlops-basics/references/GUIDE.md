...
This guide provides comprehensive documentation for the **mlops-basics** skill in the custom-plugin-mlops plugin.
...
```bash
# Invoke the skill
claude "mlops-basics - [your task description]"

# Example
claude "mlops-basics - analyze the current implementation"
```
...
def implement_mlops_basics(input_data):
    """
    Implement mlops-basics functionality.

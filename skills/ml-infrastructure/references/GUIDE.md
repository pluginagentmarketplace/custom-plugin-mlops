# Ml Infrastructure Guide

## Overview

This guide provides comprehensive documentation for the **ml-infrastructure** skill in the custom-plugin-mlops plugin.
...
```bash
# Invoke the skill
claude "ml-infrastructure - [your task description]"

# Example
claude "ml-infrastructure - analyze the current implementation"
```
...
def implement_ml_infrastructure(input_data):
    """
    Implement ml-infrastructure functionality.

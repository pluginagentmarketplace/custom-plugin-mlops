...
1. **Identify Your Target Agent**
2. **Complete the Assessment** for that agent
3. **Follow the Recommendations**
4. **Use `/learn` Command** to study
5. **Work on `/projects` Command** to practice
6. **Re-assess** after 2-3 months
